...
<section align="center">
    <div class="item">
        <table border="5" bordercolor="#FFC0CB">
            <caption class="zag"><?php print('Информация о заказе №' . $_SESSION['ID_Order'] . ''); ?></caption>
            <tr>
                <th align="center" width="300" colspan="4" style="background-color:Pink">Товар</th>
                <th align="center" width="110" colspan="2" style="background-color:Pink">Количество</th>
                <th align="center" width="110" colspan="2" style="background-color:Pink">Стоимость</th>
            </tr>
            <?php
            $sql = 'SELECT * FROM orders WHERE ID_Order="' . $_SESSION['ID_Order'] . '"';
            $result = mysqli_query($mysqli, $sql);
            $rows = mysqli_fetch_all($result, MYSQLI_ASSOC);

            $sql4 = 'SELECT * FROM change_order_status WHERE ID_Order="' . $_SESSION['ID_Order'] . '"';
            ...
            $sql6 = 'SELECT * FROM change_order_status WHERE ID_Status ="1" AND ID_Order="' . $_SESSION['ID_Order'] . '"';
            $result_sql6 = mysqli_query($mysqli, $sql6);
            $rows_sql6 = mysqli_fetch_all($result_sql6, MYSQLI_ASSOC);

            $sql3 = 'SELECT * FROM kinds_orders WHERE ID_Order="' . $_SESSION['ID_Order'] . '"';
            ...
            for ($k = 0; $k < 1; $k++) {
                ...
                for ($m = 0; $m < $num_rows_sql3; $m++) {
                    ...
                    ?>
                    <tr>
                        <td align="center" height="150" width="150" colspan="2"><img
                                    src="img/<?php print($rows_sql2[0]['Product_Img']); ?>" width="170"
                                    alt="<?= $product['Name'] ?>"></td>
                ...
                <tr>
                    ...
                    <td align="center" colspan="2"><?php print($rows[0]['Date_Complete']); ?></td>
                ...
                <tr>
                    ...
                    <td align="center" colspan="2"><?php if (isset($rows_sql6[0]['Date_Change'])) {
                            print($rows_sql6[0]['Date_Change']);
                        } else {
                            print('-');
                        } ?></td>
    ...
    <p>Вернуться в<a href="/personal_account.php">личный кабинет</a></p>
</section>
