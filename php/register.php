    ...
    if (isset($_POST["captcha"]) && !empty($captcha)) {
        ...
        if (isset($_POST["email"])) {
            ...
            if (!empty($email)) {
                ...
                $result_query = $mysqli->query("SELECT `Email` FROM `buyers` WHERE `Email`='" . $email . "'");
        ...
        $result_query_insert = $mysqli->query("INSERT INTO `buyers` (Name, Surname, Email, Password) VALUES ('" . $first_name . "', '" . $last_name . "', '" . $email . "', '" . $password . "')");
